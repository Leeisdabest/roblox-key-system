...
5. Website checks that they started from /generate-key in the same browser.
6. Website shows a check mark, a 24 hour key, and a countdown timer.
...
The website does not show this return URL on the public key page.
It also uses a short browser session so opening /unlock directly will not generate a key.
