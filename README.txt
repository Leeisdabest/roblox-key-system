...
4. If Linkvertise returns to /unlock, the key is generated.
5. If Linkvertise returns to /generate-key by mistake, the website still detects the session and generates the key.
6. If Linkvertise does not auto-return, the fallback claim button can generate the key after 25 seconds.
