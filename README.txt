...
2. Website sends them to Linkvertise.
3. Linkvertise sends them back to /unlock.
4. Website gives them a 24 hour key.
5. Roblox checks the key with /check-key.
