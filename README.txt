...
3. Linkvertise sends them back to:
       ...
       https://roblox-key-system-hr3h.onrender.com/unlock?pass=YOUR_SECRET_PASS

4. The website gives them a random 24 hour key.

5. The Roblox loader checks the key with:

       https://roblox-key-system-hr3h.onrender.com/check-key?key=THE_KEY
...
Example:
    ...
    https://roblox-key-system-hr3h.onrender.com/unlock?pass=my-secret-pass-9284
