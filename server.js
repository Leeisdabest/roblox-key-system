...
const server = http.createServer((req, res) => {
  ...
  if (url.pathname === "/" || url.pathname === "/generate-key") {
    ...
    if (pending) {
      ...
      return page(
        ...
        <p>Finish Linkvertise until it sends you to the verified unlock page automatically.</p>
  ...
  if (url.pathname === "/claim") {
    ...
    return page(
      ...
      "Locked",
      `<h1>Locked</h1>
      <p>This shortcut is disabled. Finish Linkvertise until it opens the verified unlock page.</p>
      <a href="/generate-key">Go Through Linkvertise</a>`
    );
  }
