...
const server = http.createServer((req, res) => {
  ...
  if (url.pathname === "/" || url.pathname === "/generate-key") {
    ...
    if (pending) {
      ...
      return page(
        res,
        "Finish Linkvertise",
        `<h1>Finish Linkvertise</h1>
        <p>You came back to the key page, so no key was generated.</p>
        <p>Finish Linkvertise until it sends you to the verified return page automatically.</p>
        <a href="/go">Open Linkvertise Again</a>`
      );
    }
    ...
    return page(
      ...
      <a href="/go">Click Here To Open Linkvertise</a>
  ...
  if (url.pathname === "/return" || url.pathname === "/unlock") {
    ...
    if (pass !== UNLOCK_PASS || !pending) {
      ...
      return page(
        ...
        <p>If you did finish Linkvertise, your Linkvertise destination is probably set to the wrong URL.</p>
