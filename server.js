    ...
    if (pass !== UNLOCK_PASS) {
      ...
      return page(
        ...
        `<section class="hero">
          ...
          <h1>Wrong Return</h1>
          <p>The return pass is wrong. Set the Linkvertise destination to the exact /return link from the README.</p>
          <div class="actions">
    ...
    if (!pending || pending.step !== 2) {
      ...
      return page(
        ...
        `<section class="hero">
          ...
          <p>This return page only works after checkpoint 1 and checkpoint 2 are completed in the same browser.</p>
          <div class="actions">
            <a class="primary" href="/generate-key">Start Again</a>
          </div>
        </section>`
